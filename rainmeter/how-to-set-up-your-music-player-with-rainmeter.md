---
title: How to set up your music player with Rainmeter
layout: default
parent: Rainmeter
nav_exclude: true
---

# How to set up your music player with Rainmeter
...
**Step 1**: Download and install the [foo_cad_plus](https://github.com/RangerCD/foo-cad-plus/releases/latest)[^1] plugin for foobar2000.  
...
[^1]: [Here](/assets/downloads/foo_cad_plus-1.3.3.fb2k-component)'s an alternative link, should the download link ever disappear.